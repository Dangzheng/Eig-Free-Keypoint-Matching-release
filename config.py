...
data_arg.add_argument(
    "--data_tr", type=str, default="brown_bm_3_05", help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default="brown_bm_3_05", help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default="brown_bm_3_05", help=""
...
train_arg.add_argument(
    "--train_lr", type=float, default=1.e-4, help=""
    "learning rate")
train_arg.add_argument(
...
train_arg.add_argument(
    "--val_intv", type=int, default=1000, help=""
    "validation interval")
train_arg.add_argument(
...
def setup_dataset(dataset_name):
    ...
    if is_computecanada():
        ...
        data_dir = "/cvlabdata2/home/zdang/datasets/scenedata_splits/"
    else:
        data_dir = "/cvlabdata2/home/zdang/datasets/scenedata_splits/"
